...
class Kernel:
    def __init__(self, parent, config: dict) -> None:
        ...
        self._cargo_manifests = {
            ...
            "kconfig": self._package.src_dir / "subprojects" / "kconfig" / "rust" / "kconfig" / "Cargo.toml",
            "kconfig_import": self._package.src_dir / "subprojects" / "kconfig" / "rust" / "kconfig_import" / "Cargo.toml",
        }
